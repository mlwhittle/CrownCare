...
export default function Reports({ isStylistView, mockedClientData }) {
    const { getDaysTracking, getStreak, photos, treatments, nutritionLogs, journalLogs, isStylistAccount, stylistCode } = useApp();
                ...
                <div style={{ background: 'rgba(59, 130, 246, 0.15)', border: '1px solid rgba(59, 130, 246, 0.4)', borderRadius: '12px', padding: '16px', display: 'flex', alignItems: 'flex-start', gap: '12px', textAlign: 'left', marginBottom: '1.5rem', animation: 'fadeIn 0.5s ease-out' }}>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: 1.5 }}>
                            This analytics data takes your hair care to a new level when tracked by a professional. Ask your stylist for their CrownCare invite code to connect to your journal!
                        </p>
                    </div>
                </div>
            )}
