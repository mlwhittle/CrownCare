...
const LEONARDO_API_KEY = process.env.LEONARDO_API_KEY || '***REMOVED***'; // Fallback for local testing
...
async function publishToFacebook(pageId, imageUrl, caption) {
    try {
        const PAGE_ACCESS_TOKEN = process.env.META_PAGE_ACCESS_TOKEN || '***REMOVED***';
